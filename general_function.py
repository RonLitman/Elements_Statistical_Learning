...
def clean_data(train, test):
    ...
    user_average_train = train['train_ratings_all'].mean(axis=1)
    user_average_test = test['test_ratings_all'].mean(axis=1)
    user_sum_train = train['train_ratings_all'].astype(bool).sum(axis=1)
    user_sum_test = test['test_ratings_all'].astype(bool).sum(axis=1)
    ...
    train['train_ratings_all']['user_average'] = user_average_train
    test['test_ratings_all']['user_average'] = user_average_test
    train['train_ratings_all']['user_sum'] = user_sum_train
    test['test_ratings_all']['user_sum'] = user_sum_test
    return train, test
